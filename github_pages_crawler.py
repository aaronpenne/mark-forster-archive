...
class GitHubPagesCrawler:
    ...
    def load_progress(self):
        ...
        try:
            with open(self.progress_file, 'r') as f:
                ...
                logger.info(f"Resuming crawl: {progress['completed_count']} posts already completed")
    ...
    def add_to_index(self, post_data, file_path):
        ...
        index_entry = {
            ...
            'categories': [cat.get('name', str(cat)) if isinstance(cat, dict) else str(cat) for cat in post_data.get('categories', [])],
    ...
    def create_github_pages_index(self):
        ...
        sorted_posts = sorted(self.index_data, 
        ...
        for year in sorted(posts_by_year.keys(), reverse=True):
            ...
            for post in posts:
                ...
                index_content.append(f"- [{post['title']}]({rel_path}){comments_text}{categories_text}")
