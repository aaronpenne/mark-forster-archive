...
If I’ve counted right there are twelve entrants in the Lenten Challenge, including myself, who have put \*[Get It Right Keep It Right](2021-02-11-get-it-right-and-keep-it-right-revised-instructions.md)\* as the method they are going to keep to for the duration of the Challenge.
...
Comments on how people are getting on with other methods should go on the previous post ([Lenten Challenge Entries](2021-02-15-lenten-challenge-entries.md)).
...
<< But since the idea of the system is to get something right and then keep it right, there doesn't seem to be much point in entering something you're not going to start getting right yet. >>  
...
This is sounding more and more like something I should try. I've done an informal version of this in some areas before, but stopped too soon.  
...
One challenge that I set for myself this time around (I have entered the Lenten Challenge multiple time, but never finished) is that I won´t give up as soon as I go off the rails with the system I choose. Not an "all or nothing" approach this time.  
...
I had a hard job deciding whether to do GIRKIR or SNL for the Lenten Challenge. (SNL has been my go-to system for quite a while now - thanks Seraphim).   
...
<< Things which have been bugging me for ages, have suddenly got resolved. >>  
...
I'm struggling a bit at the moment with GIRKIR. I have multiple one-off tasks and ongoing projects that haven't been touched over the last 11 days – so far without any bad consequences, but they can't stay undone indefinitely.  
...
Thanks, Mark. I'll give that suggestion a try.   
...
I still want to try to make the system work using the "work as long as I want to" rule, because I just hate the time boxing stuff, even the way that you describe it.   
...
Mark, since you said that you don't include everything on the list that you do more or less automatically, I'm going to experiment with that approach.   
