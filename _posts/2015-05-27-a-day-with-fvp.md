...
Here’s what I managed to do today using [FVP](http://markforster.squarespace.com/blog/2015/5/21/the-final-version-perfected-fvp.html). The tasks are in the order in which they are written on my list rather than the order I actually did them.
